...
@echo off
cd ..
set file_path="../clean_files/scenes/05.2_bamboo/05.2c_comp.blend"
echo %file_path%
set start_frame=148
set end_frame=197

start "05.2_bamboo/05.2c_comp" python .\run_blender.py %file_path% -resume "0 0" -end "8 8" -fs %start_frame% -fe %end_frame%
