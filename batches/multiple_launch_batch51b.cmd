...
@echo off
cd ..
set file_path="../clean_files/scenes/05.1_questbegins/05.1b_comp.blend"
echo %file_path%
set start_frame=127
set end_frame=166

start "05.1_questbegins,05.1b_comp" python .\run_blender.py %file_path% -resume "0 0" -end "8 8" -fs %start_frame% -fe %end_frame%
