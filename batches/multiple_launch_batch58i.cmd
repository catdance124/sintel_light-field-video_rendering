...
@echo off
cd ..
set file_path="../clean_files/scenes/05.8_ambushfight/05.8i_comp.blend"
echo %file_path%
set start_frame=635
set end_frame=684

start "05.8_ambushfight/05.8i_comp" python .\run_blender.py %file_path% -resume "0 0" -end "8 8" -fs %start_frame% -fe %end_frame%
