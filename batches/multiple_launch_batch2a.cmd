...
@echo off
cd ..
set file_path="../clean_files/scenes/02_shaman/02.a_comp.blend"
echo %file_path%
set start_frame=101
set end_frame=150

start "02_shaman,02.a_comp" python .\run_blender.py %file_path% -resume "0 0" -end "8 8" -fs %start_frame% -fe %end_frame%
