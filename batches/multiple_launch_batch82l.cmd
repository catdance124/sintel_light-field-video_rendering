...
@echo off
cd ..
set file_path="../clean_files/scenes/08.2_thebigfight/08.2l_comp.blend"
echo %file_path%
set start_frame=530
set end_frame=579

start "08.2_thebigfight,08.2l_comp" python .\run_blender.py %file_path% -resume "0 0" -end "8 8" -fs %start_frame% -fe %end_frame%
