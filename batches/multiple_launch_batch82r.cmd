...
@echo off
cd ..
set file_path="../clean_files/scenes/08.2_thebigfight/08.2r_comp.blend"
echo %file_path%
set start_frame=898
set end_frame=947

start "08.2_thebigfight,08.2r_comp" python .\run_blender.py %file_path% -resume "0 0" -end "8 8" -fs %start_frame% -fe %end_frame%
