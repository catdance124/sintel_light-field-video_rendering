...
@echo off
cd ..
set file_path="../clean_files/scenes/03.4_chickenrun/03.4a_comp.blend"
echo %file_path%
set start_frame=16
set end_frame=65

start "03.4_chickenrun,03.4a_comp" python .\run_blender.py %file_path% -resume "0 0" -end "8 8" -fs %start_frame% -fe %end_frame%
