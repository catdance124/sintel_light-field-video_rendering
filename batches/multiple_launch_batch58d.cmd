...
@echo off
cd ..
set file_path="../clean_files/scenes/05.8_ambushfight/05.8d_comp.blend"
echo %file_path%
set start_frame=449
set end_frame=468

start "05.8_ambushfight,05.8d_comp" python .\run_blender.py %file_path% -resume "0 0" -end "8 8" -fs %start_frame% -fe %end_frame%
