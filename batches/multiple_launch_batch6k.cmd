...
@echo off
cd ..
set file_path="../clean_files/scenes/06_shaman_b/06.k_comp.blend"
echo %file_path%
set start_frame=710
set end_frame=759

start "06_shaman_b,06.k_comp" python .\run_blender.py %file_path% -resume "0 0" -end "8 8" -fs %start_frame% -fe %end_frame%
