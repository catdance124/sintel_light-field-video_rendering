...
@echo off
cd ..
set file_path="../clean_files/scenes/03.3_sleeping/03.3c_comp.blend"
echo %file_path%
set start_frame=281
set end_frame=310

start "03.3_sleeping,03.3c_comp" python .\run_blender.py %file_path% -resume "0 0" -end "8 8" -fs %start_frame% -fe %end_frame%
